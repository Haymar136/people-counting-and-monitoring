...
parser.add_argument('--video', default='videos/cctv1.mp4', help='Path to video file.')
...
config.in_count1 = 0
config.out_count1 = 0
config.in_time1 = date_time
config.out_time1 = date_time

#API_ENDPOINT = config.API_ENDPOINT
#API_CAM1 = config.API_CAM1
connection_string = config.conn1
event_hub_name = config.event_hub1
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        if classIds[i] == 0:
            ...
            json_message = {
                    'store_name': 'Store 1',
                    'in_count': config.in_count1,
                    'out_count': config.out_count1,
                    'in_time': config.in_time1,
                    'out_time': config.out_time1
            } 
