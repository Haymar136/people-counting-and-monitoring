...
parser.add_argument('--video', default='test2.mp4', help='Path to video file.')
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        if classIds[i] == 0:
            ...
            requests.post(url=API_CAM3, data = json.dumps(body), headers=headers) 
            requests.post(url=API_ENDPOINT, data = json.dumps(body), headers=headers) 
        ...
        # to determine direction
            ...
            if not to.counted:
                ...
                if direction < 0 and centroid[1] in range(frameHeight//2 - 30, frameHeight//2 + 30):
                    ...
                    config.out_count3 += totalUp
                    config.out_time3 = out_time
                ...
                # People IN count  
                    ...
                    config.in_count3 += totalDown
                    config.in_time3 = in_time
