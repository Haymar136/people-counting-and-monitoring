...
parser.add_argument('--video', default='videos/test2.mp4', help='Path to video file.')
...
config.in_count2 = 0
config.out_count2 = 0
config.in_time2 = date_time
config.out_time2 = date_time

#API_ENDPOINT = config.API_ENDPOINT
#API_CAM1 = config.API_CAM2
connection_string = config.conn2
event_hub_name = config.event_hub2
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        if classIds[i] == 0:
            ...
            json_message = {
                    'store_name': 'Store 2',
                    'in_count': config.in_count2,
                    'out_count': config.out_count2,
                    'in_time': config.in_time2,
                    'out_time': config.out_time2
            } 
